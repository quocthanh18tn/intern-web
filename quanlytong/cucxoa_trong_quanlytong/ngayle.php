...
#col-25 {
 ...
 <body>
    ...
    <a href="ngayle.php"        class="w3-bar-item w3-button" id="lib-thanh-active" ">Create Holiday  </a>

     <div class="w3-dropdown-hover">
      <button class="w3-button" style="padding: 14px;width: 100px;">Panel       </button>
        ...
        <br>
            <form action="" method="POST">
              <div>
                ...
                <input type="submit" name ="them"  id="them" style="border-radius: 18px;width: 146px;margin-left: 10px;" class="btn btn-primary" value="ADD HOLIDAY"></input>
            </form>
            <br>
            <br>
            <form action="" method="POST">
              <div>
                  ...
                  <input type="submit" name ="xoa"  id="xoa" class="btn btn-primary" style="border-radius: 18px;margin-left: 278px;" value="DELETE HOLIDAY" ></input>
              </div>
            </form>
