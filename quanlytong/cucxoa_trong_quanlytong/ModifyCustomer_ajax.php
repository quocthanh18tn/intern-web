...
<?php
		...
		{
			?>
			<span style="color: red; text-align: center;margin-left: 120px;"> Code is not existed</span>
			<?php
		}
...
{
			?>
			<span style="color: red; text-align: center;margin-left: 60px;">Have many code, please choose phone </span>
			<br>
			<lable for = "text1" class="word" >Customer: </label>
