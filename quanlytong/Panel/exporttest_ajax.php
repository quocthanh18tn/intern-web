...
<?php
		...
		{
			?>
			<span style="color: red; text-align: center;margin-left: 5%;font-size: 18px;"> InValid. ID is not existed</span>
			<?php
		}
			 ...
			 if ($tb!="")
      {
      	?>
      	<br>
<p style="clear: left;font-size: 20px;">Project Information</p>
  ...
  <?php
    ...
    <tr >
    <td style="border: solid 1px;font-size: 20px;font-weight: normal;"><?php echo $temp[0];?></td>
    <td style="border: solid 1px;font-size: 20px;font-weight: normal;"><?php echo $temp[1];?></td>
    <td style="border: solid 1px;font-size: 20px;font-weight: normal;"><?php echo $panel_num;?></td>
    <td style="border: solid 1px;font-size: 20px;font-weight: normal;"><?php echo $name;?></td>
    </tr>
			<?php
