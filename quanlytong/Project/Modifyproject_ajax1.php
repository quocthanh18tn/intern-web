...
<?php
		...
		{
			?>
			<span style="color: red; text-align: center;margin-left: 1%;font-size: 18px;"> InValid. ID is not existed</span>
			<?php
		}
  ...
  <tr style="border: solid 2px;">
    <th style="border: solid 2px;font-size: 20px;font-weight: bold;">Project ID</th>
    <th style="border: solid 2px;font-size: 20px;font-weight: bold;">Name</th>
    <th style="border: solid 2px;font-size: 20px;font-weight: bold;">Number of Panel</th>
    <th style="border: solid 2px;font-size: 20px;font-weight: bold;">Customer</th>
  </tr>
  <?php
    ...
    <tr >
    <td style="border: solid 2px;font-weight: normal;"><?php echo $temp[0];?></td>
    <td style="border: solid 2px;font-weight: normal;"><?php echo $temp[1];?></td>
    <td style="border: solid 2px;font-weight: normal;"><?php echo $panel_num;?></td>
    <td style="border: solid 2px;font-weight: normal;"><?php echo $name;?></td>
    </tr>
			<?php
