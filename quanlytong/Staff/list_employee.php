   ...
   <div class="w3-dropdown-hover">
    ...
    <a class="w3-bar-item w3-button"  href="../logout.php" id="lib-thanh-logout">Logout</a>
          ...
          <form method ="POST" action="" >
                        <lable for = "text1" class="word" > Info Employee: </label>
                        <input type ="text" name="text1" class="text1" placeholder="ID, Name, Dep, Sub_dep"   > </input>
                         <input type = "submit" name="button1" value= "Submit" class="btn btn-lg btn-primary" style="margin-left: 2%;width:110px;margin-top: 0.1%;">
                         <br>
                <input type = "submit" name="button2" value= "Show all" class="btn btn-lg btn-primary" style="margin-left: 46.8%;margin-top: 2%;margin-bottom: 2%;">
