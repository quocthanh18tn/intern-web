...
<div id="id01" class="modal10">  
  <form class="modal-content10 animate" action="">
    ...
    <div class="container">
      ...
      <input type="text" placeholder="Enter your ID" name="uname" id ="msql_msql"required>
      <div>
        <br>
      <div>
...
<script type="text/javascript">
  $(document).ready(function(){
    $("#xacnhanketthuc").click(function(){
                ...
                msgd = "#"+msgd+chon;
                msgd =$(msgd).val();
                $.post("xuly_xacnhanhoanthanh.php", {idql:id,pass:pass,mskhungtu:mskhungtu,msgd:msgd}, function(data){$("#xulytrangxacnhan").html(data);})
            });
