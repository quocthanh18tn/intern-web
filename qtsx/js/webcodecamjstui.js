...
var WebCodeCamJS = function(element) {
    ...
    mediaDevices.getUserMedia = function(c) {
        return new Promise(function(y, n) {
            (window.navigator.getUserMedia || window.navigator.mozGetUserMedia || window.navigator.msGetUserMedia || window.navigator.mediaDevices.getUserMedia || window.navigator.webkitGetUserMedia).call(navigator, c, y, n);
        });
    }
    ...
    function setEventListeners() {
        video.addEventListener('canplay', function(e) {
            if (!isStreaming) {
                ...
                display.setAttribute('width', w);//mặc định là w,nhưng sửa lại thành số ...
                display.setAttribute('height', 150);//mặc định là h,nhưng sửa lại thành số 150
                isStreaming = true;
        ...
        video.addEventListener('play', function() {
            setInterval(function() {
                if (!video.paused && !video.ended) {
                    ...
                    var imageData = con.getImageData(0, 0, w, 150);//mặc định là h,nhưng sửa lại thành số 150
