...
-->
    <form method="post" action="" id="quanlyduan.css" autocomplete="off">
                ...
                if ($_POST['dongy']==1)
                    {
                        $tb = mysql_query("SELECT mskhungtu,msnv,giaidoan.tengd,minutes_dukien,date_start,date_finish FROM qtsx INNER JOIN giaidoan WHERE qtsx.msgd=giaidoan.msgd AND mskhungtu = '$_POST[mskhungtu]' ORDER BY qtsx.msgd");
